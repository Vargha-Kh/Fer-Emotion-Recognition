...
class VIT(nn.Module):
    ...
    def __init__(self, img_size= (48,48),patch_size= (8,8), emb_dim = 1280, mlp_dim=5120, num_heads=16, num_layers=32, n_classes=7, dropout_rate=0.1, at_d_r=0.0):
        ...
        self.patch_embed = Conv2d(in_channels=1,
...
class Mlp(nn.Module):
    def __init__(self, emb_dim, mlp_dim, dropout_rate=0.1):
