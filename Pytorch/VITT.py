...
class VIT(nn.Module):
    ...
    def __init__(self, img_size=(48, 48), patch_size=(8, 8), emb_dim=128, mlp_dim=128, num_heads=2, num_layers=10,
                 n_classes=7, dropout_rate=0.5, at_d_r=0.0):
...
class Mlp(nn.Module):
    def __init__(self, emb_dim, mlp_dim, dropout_rate=0.5):
