...
if __name__ == "__main__":
    ...
    FER_VT = VIT(img_size= (48,48),patch_size= (8,8), emb_dim = 1024, mlp_dim=4096, num_heads=16, num_layers=24, n_classes=num_classes, dropout_rate=0.25, at_d_r=0.1).to(device)
